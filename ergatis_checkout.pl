...
#4) copy of dtdValid.pl file that for some reason is not included as part of CVS install
#/bin was created during the cvs install process
#print $exec_path."/dtdValid.pl $install_root/bin\n";
#copy($exec_path."/dtdValid.pl", "$install_root/bin") || die ("Unable to copy dtdValid.pl to $install_root/bin: $!");
#doORdie("chmod 777 $install_root/bin/dtdValid.pl");
#chmod("$install_root/bin/dtdValid.pl", 0777);
