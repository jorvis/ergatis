...
Logger.pm - A module for providing debugging methods to OBO and OBO projects.
...
This module is intended to provide OBO, and OBO client projects, with an easy to
...
my $logger = new OBO::Logger( 'LOG_LEVEL'=>2, #verbose debugging
			       'LOG_FILE'=> 'my.obo.log'
			       );

B<Returns:> $self (A OBO::Logger object).
