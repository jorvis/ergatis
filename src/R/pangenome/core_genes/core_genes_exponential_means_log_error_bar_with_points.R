...
postscript(file="###output_path###core_genes_exponential_means_log_error_bar_with_points.ps", width=11, height=8.5, paper='special')
layout(matrix(c(1,2),byrow=TRUE), heights=c(7.5,1))

# Draw the axis
plot(V1,V2, xlab="number of genomes", ylab="core genes", main="###TITLE### core genes exponential log axis", cex=0.2, log="xy", col=p_color)
