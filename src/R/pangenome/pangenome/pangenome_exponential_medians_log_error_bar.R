...
# Draw the axis
plot(V1,V2, ylim=c(min(V2),nlmodel_exp$m$getPars()[1]), xlab="number of genomes", ylab="new genes", main="###TITLE### pangenome exponential log axis", cex=0.5, log="xy", type="n")
