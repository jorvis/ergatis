...
BEGIN {
    require '/usr/local/devel/ANNOTATION/ard/chado-v1r5b1/lib/site_perl/5.8.5/GenePredictionUtils/FGeneShBsmlGenerator.pm';
    import GenePredictionUtils::FGeneShBsmlGenerator;
}
