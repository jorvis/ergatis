...
my $output= "SNP_" . $filename . ".fasta";
	...
	system("~/src/SNP/quality_SNP_pcr.pl -G ~/src/SNP/$con -F $directory/$file -I $directory2/$file.align -C $directory3/$file3.contig -T $filename -D $file3 -V $directory4/$file3.tcov -O $output");
