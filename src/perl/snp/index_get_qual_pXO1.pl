...
my $newcov;
my @quality;
my $tcov2 = "/usr/local/projects/anthrax/jravel/pXO1_cov.dir/ungapped_pXO1.tcov";
my $tcov = "/usr/local/projects/anthrax/jravel/index_pXO1.tcov";
my $add;
my $list;
my @coverage;
my $fh;
...
## time  opening of index and storing into an array
...
sub pos_trans2 {
 ...
 if ($pos > 19569 && $pos < 183238) {
     $pos2 = $pos - 19570;
     $pos2 +=1;
    
 }elsif ($pos < 19570) {
     $pos2 = ($pos -1561) + 163669;
     $pos2 +=1;
 }
