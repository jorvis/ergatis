...
system("~/src/SNP/SNP_distances.pl -F $SNPfile1");


system("~/src/SNP/trans_align2.pl -F SNP_align.txt");
system("~/src/SNP/trans_quality.pl -F SNP_quality.txt");
...
if ($genome eq "G") {
    ...
    system ("~/src/SNP/index_get_qual.pl -F SNP_quality2.txt");
    print "Done.\n\n";
    print "\n Getting information on Synonymous-NonSynonymous SNPs...\n ";
    system ("~/src/SNP/syn_nonsyn2.pl -F SNP_final.txt -T $tag");
...
system ("~/src/SNP/STATS.dir/SNP_parser3.pl -F output.final");
system ("~/src/SNP/STATS.dir/final_parse.pl -F SNPs2.txt");
system ("~/src/SNP/STATS.dir/stats.pl -F HH.snp -T $tag");
...
system ("~/src/SNP/cov_indel4.pl -T $tag -F INDEL_info.txt > INDEL_high.txt");
