...
def main():
   '''
   Input files: for example, input_R1.fq input_R2.fq
   Output files: outPaired_R1.fq outPaired_R2.fq outOrphan.fq
   '''
   if len(sys.argv) < 6:
       print "Usage: python fq_getPairAndOrphan.py input_R1.fq input_R2.fq outPaired_R1.fq outPaired_R2.fq outOrphan.fq"
       sys.exit(1)
