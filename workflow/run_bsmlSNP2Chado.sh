...
wfname="bsmlPairwiseCompute2Chado"
...
mkdir -p $wfnamedir
$WRAPPERPATH/set_runtime_vars_bsmlPairwiseCompute2Chado.sh -t $target_database -w $wfname -r $wfnamedir -b $bsml_doc -v $target_server -d $date -p $project
