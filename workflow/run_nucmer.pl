...
Generate NUCmer search data from a BSML data repository. Each input sequence is searched against all sequences in the repository.

USAGE: run_nucmer -d DATABASE_NAME 
...
# The default nucmer configuration
...
my $conf = {
    ...
    ';MASTER_CONF;' => "$WorkflowConfigFileDir/nucmer-master.ini",
    ';MASTER_TEMPLATE;' => "$WorkflowConfigFileDir/nucmer-master_template.xml",
    ';SUBFLOW_CONF;' => "$WorkflowConfigFileDir/nucmer.ini", 
    ';SUBFLOW_TEMPLATE;' => "$WorkflowConfigFileDir/nucmer_template.xml",
    ';NUCMER_BREAKLEN;' => '200',
    ';NUCMER_MINCLUSTER;' => '65',
    ';NUCMER_DIAGFACTOR;' => '0.12',
    ';NUCMER_MAXGAP;' => '90',
    ';NUCMER_MINMATCH;' => '20',
    };
...
system "cp $conf->{';SUBFLOW_TEMPLATE;'} $conf->{';REPOSITORY_ROOT;'}/$conf->{';DATABASE;'}/Workflow/$conf->{';WFNAME;'}/$conf->{';WFID;'}/nucmer_template.xml";
system "chmod 666 $conf->{';REPOSITORY_ROOT;'}/$conf->{';DATABASE;'}/Workflow/$conf->{';WFNAME;'}/$conf->{';WFID;'}/nucmer_template.xml";
