...
Generate PROmer search data from a BSML data repository. Each input sequence is searched against all sequences in the repository.

USAGE: run_promer -d DATABASE_NAME 
...
See http://www.tigr.org/software/mummer/manual/ for PROmer documentation and explanation of parameters.
...
# The default promer configuration
...
my $conf = {
    ...
    ';PROMER_BREAKLEN;' => '60',
    ';PROMER_MINCLUSTER;' => '20',
    ';PROMER_DIAGFACTOR;' => '0.11',
    ';PROMER_MAXGAP;' => '30',
    ';PROMER_MINMATCH;' => '6',
    ';PROMER_MASKLEN;' => '8',
    ';MASTER_CONF;' => $WorkflowConfigFileDir."/promer-master.ini",
    ';MASTER_TEMPLATE;' => $WorkflowConfigFileDir."/promer-master_template.xml",
    ';SUBFLOW_CONF;' => $WorkflowConfigFileDir."/promer.ini", 
    ';SUBFLOW_TEMPLATE;' => $WorkflowConfigFileDir."/promer_template.xml"
    };
...
system "cp $conf->{';SUBFLOW_TEMPLATE;'} $conf->{';REPOSITORY_ROOT;'}/$conf->{';DATABASE;'}/Workflow/$conf->{';WFNAME;'}/$conf->{';WFID;'}/promer_template.xml";
system "chmod 666 $conf->{';REPOSITORY_ROOT;'}/$conf->{';DATABASE;'}/Workflow/$conf->{';WFNAME;'}/$conf->{';WFID;'}/promer_template.xml";
